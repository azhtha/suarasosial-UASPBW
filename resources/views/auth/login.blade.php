...
<body class="bg-linear-to-br from-(--lavender)] to-(--background)] min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <!-- Logo Card -->
        <div class="text-center mb-8">
            <div class="inline-block bg-white p-4 rounded-full mb-4 shadow-lg">
                <i class="fas fa-bullhorn text-(--primary)] text-4xl"></i>
            </div>
            <h1 class="text-4xl font-bold text-(--text)] mb-2">SuaraSosial</h1>
        </div>

        <!-- Login Card -->
        <div class="bg-white rounded-lg shadow-2xl p-8 border border-(--border-soft)]">
            ...
            <form method="POST" action="{{ route('login.store') }}" class="space-y-6 js-loading-form">
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-4 py-2 border border-(--border-soft)] rounded-xl focus:outline-none focus:border-(--primary)] focus:ring-2 focus:ring-(--lavender)]/30 @error('email') border-red-500 @enderror"
                    >
                </div>
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-4 py-2 border border-(--border-soft)] rounded-xl focus:outline-none focus:border-(--primary)] focus:ring-2 focus:ring-(--lavender)]/30 @error('password') border-red-500 @enderror"
                    >
                </div>
            ...
            <div class="mt-8 pt-6 border-t border-(--border-soft)]">
                <p class="text-center text-sm text-(--text-muted)] mb-3">
                    <i class="fas fa-info-circle text-(--primary)] mr-1"></i>Demo Credentials:
                </p>
                <div class="bg-(--lavender)]/20 rounded p-3 text-sm space-y-1 text-(--text-muted)]">
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('home') }}" class="text-(--primary)] hover:text-(--primary-dark)] text-sm flex items-center justify-center">
