...
@section('content')
    <div class="max-w-2xl mx-auto">
        <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="bg-white rounded-lg shadow p-8">
            ...
            <div class="mb-6 p-3 bg-[var(--background)] rounded text-sm text-[var(--text-muted)] border border-[var(--border-soft)]">
                <i class="fas fa-info-circle text-[var(--primary)] mr-2"></i>
