            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6 border border-(--border-soft)">
                    ...
                    <div class="mb-4">
                        ...
                        <div id="noImagePlaceholder" class="w-full h-40 bg-(--background) rounded-xl mb-4 flex flex-col items-center justify-center text-(--text-muted)">
                    ...
                    <p class="text-xs text-(--text-muted) mt-2">
                        <i class="fas fa-info-circle text-(--primary) mr-1"></i>Max 2MB. Format: JPG, PNG, GIF
                    </p>
                    @error('image')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
